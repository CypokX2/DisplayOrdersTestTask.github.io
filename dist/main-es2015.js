...
function getTotalOrderAmount(orderDetails) {
    return orderDetails.proposals
        .map(p => Object(_Proposal__WEBPACK_IMPORTED_MODULE_0__["calcTotalProposalAmount"])(p))
        .reduce((sum, current) => _wwwroot_lib_decimal_js_decimal_min_js__WEBPACK_IMPORTED_MODULE_1__["Decimal"].add(sum, current), 0);
}
...
function convertOrder(o, datePipe) {
    let headerV = Object(_HeaderView__WEBPACK_IMPORTED_MODULE_0__["convertHeader"])(o.header, datePipe);
    let order = {
        id: o.id,
        header: headerV,
        details: o.details
...
let OrderOverviewComponent = class OrderOverviewComponent {
    constructor() {
    ...
    get orderStatusEnum() { return _Models_OrderStatus__WEBPACK_IMPORTED_MODULE_1__["OrderStatus"]; }
    get orderStatusNames() {
        return Object.keys(_Models_OrderStatus__WEBPACK_IMPORTED_MODULE_1__["OrderStatus"])
            ...
            .map((key) => {
            return { key, value: _Models_OrderStatus__WEBPACK_IMPORTED_MODULE_1__["OrderStatus"][key] };
        });
    }
    sortHeaders(incoming) {
        if (incoming) {
            return incoming.sort((n1, n2) => {
...
let OrderWrapperComponent = class OrderWrapperComponent {
    constructor(_http, _datePipe, route) {
        this._http = _http;
    ...
    ngOnInit() {
        ...
        this._http.get(this.apiBaseUrl + 'api/orders/brief/')
            ...
            yield new Promise(resolve => setTimeout(resolve, this.pendData));
            this.headers = result.map(h => {
                return Object(_Scaffolding_ViewModels_HeaderView__WEBPACK_IMPORTED_MODULE_3__["convertHeader"])(h, this._datePipe);
            });
            this.loadingHeaders = false;
    ...
    fetchDetails(headerId) {
        ...
        this._http.get(this.apiBaseUrl + 'api/orders/details/' + headerId)
            .subscribe((result) => __awaiter(this, void 0, void 0, function* () {
            yield new Promise(resolve => setTimeout(resolve, this.pendData));
            let convertedOrder = Object(_Scaffolding_ViewModels_OrderView__WEBPACK_IMPORTED_MODULE_4__["convertOrder"])(result, this._datePipe);
            this.selectedOrder = convertedOrder;
            this.fetchingDetails = false;
        }), error => console.error(error));
    }
};
OrderWrapperComponent.ctorParameters = () => [
